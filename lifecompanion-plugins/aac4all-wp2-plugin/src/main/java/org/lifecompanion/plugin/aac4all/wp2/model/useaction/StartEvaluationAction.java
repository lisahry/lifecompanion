...
public class StartEvaluationAction extends SimpleUseActionImpl<GridPartKeyComponentI> {

    public StartEvaluationAction() {
        super(GridPartKeyComponentI.class);
        this.category = AAC4AllWp2SubCategories.TODO;
        this.nameID = "aac4aal.wp2.plugin.action.start.evalutation.name";
        this.staticDescriptionID = "aac4aal.wp2.plugin.action.start.evalutation.description";
    ...
    public void execute(final UseActionEvent event, final Map<String, UseVariableI<?>> variables) {
        AAC4AllWp2EvaluationController.INSTANCE.startEvaluation();
    }
